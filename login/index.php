    ...
    <div class="login">
      <div class="wrap">
        <div class="login-box">
          ...
          <p class="btn log-google"><a href=""><i><img src="/izbooking/common/images/share/google-identity-icon.png" alt=""></i>Log
              in with Google</a></p>
          ...
          <div class="main-log-in">
            <form action="" method="POST" name="frmlogin">
              ...
              <div class="act">
                <p class="remember"><input type="checkbox" id="remember_me"><label for="remember_me">Remember me</label></p>
                <p class="forgot"><a href="">Forgot your password</a></p>
              </div>
              <p class="btn handle-log"><a href="" id="sm-login">Login</a></p>
            </form>
          </div>
          <p class="new-here">New here ?<a href="/izbooking/login/register.html">Create an account</a></p>
        </div>
      </div>
    </div>
