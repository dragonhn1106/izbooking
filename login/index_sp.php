...
<head>
  ...
  <title>Login - ASIA PACKER TRAVEL</title>
  ...
  <link rel="stylesheet" href="/izbooking/common/css/login/style_sp.css">
</head>
  ...
  <div class="container">
    <div class="modal-login">
      <div class="modal-login-dialog">
        <p class="log-logo"><img src="/izbooking/common/images/share/logo-login.png" alt="Asia Package Travel" width="347"
            height="106"></p>
        <p class="btn log-face"><a href=""><i class="fa fa-facebook" aria-hidden="true"></i>Log in with Facebook</a></p>
        <p class="btn log-google"><a href=""><i class="fa fa-google-plus" aria-hidden="true"></i>Log in with Google</a></p>
        <p class="log-or"><span>Or</span></p>
        <div class="main-log-in">
          <form action="" method="POST" name="frmlogin">
            <p class="txtInput">
              <span class="icon"><img src="/izbooking/common/images/share/icon_user-login.png" alt="" width="30" height="28"></span>
              <input type="text" name="txtUser" placeholder="Username" class="in">
            </p>
            <p class="txtInput">
              <span class="icon"><img src="/izbooking/common/images/share/icon_pass.png" alt="" width="30" height="32"></span>
