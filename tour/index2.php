...
<body>
              ...
              <form action="" method="" class="form-box" name="tour_form_search">
                <div class="form-row">
                  ...
                  <div class="form-group select-icon select-calendar">
                    <input type="text" name="date_tour" id="date_tour" class="form-control datepicker" data-format="MM dd, yy" placeholder="August, 18 2018">
                  </div>
            ...
            <div class="sidebar">
              <div class="filter-sidebar">
                ...
                <div class="box-sidebar">
                  ...
                  <div class="inner-box">
                    <p class="datebox"><i class="fa fa-calendar"></i><input type="text" class="txtDate datepicker" placeholder="Select a specific date" id="txtDate"></p> 
                  </div>
                </div>
                <!-- /box-sidebar -->
                <div class="box-sidebar">
                  <h3>Departure date</h3>
                  <div class="inner-box">
                   <p class="range range-date"><input type="range" name="rdateMin" min="1" max="10" value="3" class="slider" id="rdateMin">
                    <!-- <input type="range" name="rdateMax" min="1" max="10" value="10" class="slider" id="rdateMax"> -->
                   </p>
                  </div>
                </div>
                <!-- /box-sidebar -->
                ...
                <div class="box-sidebar">
                  <h3>Budget</h3>
                  <div class="inner-box">
                   <p class="range"><input type="range" min="20" max="9100" value="1" class="slider" id="price01"></p>
                   <p class="txt-val"><span>$20</span><span>$9100</span></p>
                   <p class="lead">Price per day</p>
                   <p class="range"><input type="range" min="0" max="1000" value="1" class="slider" id="price02"></p>
              ...
              <ul class="list-tours">
                <li class="tour">
                  <div class="inner-tour">
                    ...
                    <div class="info-tour">
                      <div class="info-txt">
                        <h2 class="tl">Paloma Cruise 3 days/2 nights</h2>
                        <div class="rate">
                          <div class="star-rate">
                            <div class="rate-star">
                        ...
                        <p class="txt-cus">"Vietnam Intro was amazing! Went with my bf and got to see so many cool parts of the..."</p>
                      ...
                      <div class="info-schedule-price">
                        <div class="price">
                          <p class="price01">Our saving<span><b>$30</b></span></p>
                          <p class="price02">From <span>US <b>$969</b><img src="/izbooking/common/images/tour/rocket.svg" alt="" class="icon"></span></p>
                        </div>
                        <div class="date">
                        ...
                        <div class="btns">
                          <ul>
                            ...
                            <li><a href="" class="download">Download Itineraries</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
  ...
  <script src="/izbooking/common/js/hotel/index.js"></script>
</body>
</html>