...
<body>
    ...
    <div class="product-detail product-detail-hotel">
      <section class="section-breadcrumb">
        <div class="wrap">
          <ul class="breadcrumb">
            ...
            <li>
              <span>Hotel de l'Opera Hanoi MGallery</span>
            </li>
          </ul>
        </div>
      </section>
      <section class="product">
        <div class="product-entry-header">
          <div class="wrap">
            <h1 class="product-title">Hotel de l'Opera Hanoi MGallery</h1>
        ...
        <div class="product-entry-photos">
          ...
          <div class="list-photos" id="product-photos">
            <div class="photo"><a href="/izbooking/common/images/product/detail/photo01.jpg"><img src="/izbooking/common/images/product/detail/photo01.jpg" alt="" width="1215" height="500"></a></div>
            <div class="photo"><a href="/izbooking/common/images/product/detail/photo01.jpg"><img src="/izbooking/common/images/product/detail/photo01.jpg" alt="" width="1215" height="500"></a></div>
            <div class="photo"><a href="/izbooking/common/images/product/detail/photo01.jpg"><img src="/izbooking/common/images/product/detail/photo01.jpg" alt="" width="1215" height="500"></a></div>
            <div class="photo"><a href="/izbooking/common/images/product/detail/photo01.jpg"><img src="/izbooking/common/images/product/detail/photo01.jpg" alt="" width="1215" height="500"></a></div>
          </div>
        ...
        <div class="product-entry-deltail">
          ...
          <div class="overview">
           <div class="wrap">
              ...
              <div class="map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d238347.54810702655!2d105.856063!3d21.025465!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x90d6982234a65f25!2sSofitel+Legend+Metropole+Hanoi!5e0!3m2!1sen!2sus!4v1543681923448" width="600" height="450"></iframe>
                ...
                <form action="" method="" name="formBooking" class="form-box">
                  <div class="form-row">
                    <div class="form-group select-icon select-calendar w-01">
                      <input type="text" name="day_check_in" id="day_check_in" data-format="MM dd, yy" class="form-control datepicker rdu" data-placeholder="August 18, 2018"placeholder="Check in" data-picker-type="1" readonly="readonly">
                    </div>
                    <div class="form-group select-icon select-calendar w-01">
                      <input type="text" name="day_check_out" id="day_check_out" data-format="MM dd, yy" class="form-control datepicker rdu" placeholder="Check out" data-picker-type="1" readonly="readonly">
                    </div>
          ...
          <div class="facility">
           <div class="wrap">
              ...
              <p class="sub">House rules</p>
              <div class="house-box">
                <p class="time-check"><i class="fa fa-calendar"></i>Check-in <span>14:30</span></p>
                <p class="time-check"><i class="fa fa-calendar"></i>Check-out <span>12:00</span></p>
              </div>
              <div class="dl-box">
                <dl>
                  <dt class="cancel">Cancellation by Customer</dt>
                  <dd>
                    <ul class="list-dot">
                ...
                <dl>
                  <dt class="policy">Children Policy</dt>
                  <dd>
                    <ul class="list-dot">
                      <li>More than 15 days prior to check-in: FREE of charge</li>
                      <li>From 15 to 10 days prior to check-in: 50% of total rates</li>
  ...
  <script src="/izbooking/common/js/product/detail_sp.js"></script>
