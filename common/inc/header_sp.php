<header>
	<div class="main-head">
		<div class="wrap">
			...
			<h1 class="logo"><a href="/"><img src="/common/images/share/logo.png" alt="ASIA PACKER TRAVEL" width="188" height="58"></a></h1>
	...
	<?php include $_SERVER['DOCUMENT_ROOT']."/common/inc/search-mobile.php"; ?>
</header>
